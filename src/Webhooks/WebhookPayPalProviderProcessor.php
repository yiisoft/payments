...
/**
 * Provider-specific processor that connects PayPal webhook recognition, parsing, and payment mapping.
 */
final readonly class WebhookPayPalProviderProcessor implements WebhookProviderProcessorInterface
{
    public function __construct(
        ...
        private PaymentWebhookMapperInterface $paymentWebhookMapper = new WebhookPayPalPaymentWebhookMapper(),
    ) {
    }
