 ...
 */
final readonly class RobokassaEndpoints
{
    public function __construct(
        public string $invoiceApiBaseUri = 'https://services.robokassa.ru/InvoiceServiceWebApi/api',
        public string $refundApiBaseUri = 'https://services.robokassa.ru/RefundService/Refund',
        public string $xmlApiBaseUri = 'https://auth.robokassa.ru/Merchant/WebService/Service.asmx',
    ) {
